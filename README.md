...
이 스킬은 아래처럼 **사용자 질문 -> 조건 해석 -> 추천 결과 제시** 흐름으로 보여주면 이해가 쉽습니다.

| 사용자 입력 | 추천 결과 예시 |
|---|---|
| `성수 근처 평일 저녁에 뛸 수 있는 초보자 러닝 크루 추천해줘. 친목 분위기면 좋겠어.` | **1. Seongsu Social Loop**<br>지역: 서울 성수<br>일정: 화/목 19:30<br>이유: 성수권, 평일 저녁, 초보 친화, 친목 목적에 잘 맞음<br><br>**2. Hangang Newbie Pack**<br>지역: 서울 여의도/한강<br>일정: 수 20:00 / 토 08:00<br>이유: 초보자 입문용이고 평일 저녁 후보로 함께 검토 가능 |
| `잠실에서 주말 아침에 하프 준비하는 사람들 많은 러닝 모임 있을까?` | **1. Jamsil Half Lab**<br>지역: 서울 잠실<br>일정: 토 07:00 / 일 07:30<br>이유: 잠실권, 주말 아침, 하프/장거리 훈련 목적과 직접 연결됨 |

이런 형태로 보여주면 단순히 "스킬 문서가 있다"가 아니라, 사용자가 실제로 어떤 입력을 넣고 어떤 결과를 받는지 바로 이해할 수 있습니다.
